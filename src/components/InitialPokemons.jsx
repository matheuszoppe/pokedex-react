...
const [background, setBackground] = React.useState('bg-gradient-to-t from-red-600 to-red-400')

const bgstyle = "bg w-full h-screen bg-gradient-to-t  flex flex-col items-center justify-center gap-16 transition-colors"

  return (
    <div
    className={[bgstyle, background]}
    style={{background: background}}
    >
        <h1 className="text-3xl text-slate-100 font-bold">Choose your starter Pokemon!</h1>
      <div className="flex items-center justify-center flex-wrap gap-16">
        ...
        onMouseEnter={()=>{setBackground('bg-gradient-to-t from-green-800 to-green-400')}}>
        ...
        href="charmander"
        className="text-center font-medium text-slate-100 text-xl capitalize cursor-pointer"
        onMouseEnter={()=>{setBackground('bg-gradient-to-t from-orange-800 to-orange-400')}}>
        ...
        href="squirtle"
        className="text-center font-medium text-slate-100 text-xl capitalize cursor-pointer"
        onMouseEnter={()=>{setBackground('bg-gradient-to-t from-indigo-800 to-indigo-400')}}>
      ...
      <a href="/1" className="bg-red-700 hover:bg-red-600 text-red-100 text-xl font-semibold px-10 py-3 rounded-full border-2 border-red-200 ">Access PokéDex</a>
    </div>
  );
};
